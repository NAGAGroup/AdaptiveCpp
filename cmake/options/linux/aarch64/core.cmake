...
# libraries, having no internal structure to preserve. SVML is x86-only and
# absent here; SLEEF and AMATH (Arm Performance Libraries) are the arm
# candidates. libmvec needs no entry: it is part of glibc, so the only correct
# copy is the one the loader resolves in the running process.
...
# On aarch64, libmvec support in the JIT requires LLVM 21+.
